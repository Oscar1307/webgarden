<?php
include ("controlador/clistaalumnonove.php");
?>
<center>
       ...
       <tbody>
            ...
            for ($i = 0; $i < count($datos); $i++) {
                ...
                <tr>
                    ...
                    <td align="center"><img border=0 src="<?php echo $datos[$i]['foto'] ?>" width="90" height="100" /></td>
                    ...
                    <td align="center"><a href="home.php?pr=<?php echo $datos[$i]['identificacion'] ?>&acceso=112"><img border=0 src="image/novedad.png" width="35" height="35" /></a></td>
