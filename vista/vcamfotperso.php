<?php
include ("controlador/ccamfotperso.php");
?>
        ...
        <table width="700"  border="0" cellpadding="6">
            <tr>
                <td colspan="3" align="center">
                    <h2>Cambiar foto</h2>
                     <input type="hidden" name="idpersona" value="<?php echo $datospersona[0]['identificacion']?>"/>
                </td>
             ...
             <tr>  
                 ...
                 <td colspan="1" align="center"><?php echo $datospersona[0]['identificacion']?><br><?php echo $datospersona[0]['prinombre']?><br><?php echo $datospersona[0]['priapellido']?></td>
              
            </tr>
            <tr>
                <td colspan="3" align="center"><output id="list" width='100' height='110'><img src='<?php echo $datospersona[0]['foto'] ?>' width='100' height='110'/></output></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3"align="center">
                     <input type="button" onclick="location.href='home.php?acceso=113'" value="volver"/>
