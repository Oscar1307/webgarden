...
?>
<center>
<form name="form1" action="home.php?acceso=102" method="post" onSubmit="return confirm('Por  favor primero  verifique  los datos ingresados  antes de hacer clic en  !aceptar!')"  >

	<table width="700" border="0">
        <tr>
        	<td colspan="2" align="center">
            	<h2> Editar Ruta de transporte</h2>
            </td>
        ...
        <tr>
        	<td align="left">Placa del veh&iacute;culo </td> 
        	 <td> <input type="text" placeholder="Placa del veh&iacute;culo" name="placa" size="20" maxlength="15" required="required" value= "<?php echo $datos1[0]['placa'] ?>"  pattern="[A-Z]{3}[0-9]{3}" title="El formato debe coincidir con 3 letras may&uacute;sculas y 3 n&uacute;meros sin espacios." /></td>
             	 <input type="hidden" name="actu" value="actu"/>
                 <input type="hidden" name="idruta" value="<?php echo $datos1[0]['idruta']?>"     
    	...
    	<tr>
           ...
           <td> <input type="number" placeholder="N&uacute;mero de puestos" name="npuesto" size="20" maxlength="11" required="required" value= "<?php echo $datos1[0]['npuesto'] ?>" min="3" max="50"   /></td>
        </tr>
        <tr>
        	<td align="left">Conductor</td>
        	<td><select name="idconductor" >
       ...
       <?php 
		...
		?>
         ...
         <option <?php if ($datos1[0]['idconductor']==$det[$i]['identificacion']) echo "SELECTED"  ?> value=" <?php 	echo $det[$i]['identificacion'] ?>" /><?php echo $det[$i]['identificacion'] ?> <?php echo $det[$i]['prinombre'] ?> <?php 	echo $det[$i]['priapellido'] ?> </option>
       ...
       <tr>
           ...
           <td> <input type="number" placeholder="Modelo  del veh&iacute;culo" name="modelo" size="20" maxlength="11" required="required" value= "<?php echo $datos1[0]['modelo'] ?>" min="1950" /></td>
        </tr>
         <tr>
        	<td align="left">Marca del veh&iacute;culo</td>
        	<td><select name="idmarca" >
       ...
       <?php 
        ...
        <option <?php if ($datos1[0]['idmarca']==$marca[$i]['idmarca']) echo "SELECTED"  ?> value=" <?php echo $marca[$i]['idmarca'] ?>" /><?php echo $marca[$i]['nombre'] ?>  </option>
        ...
        <tr>
        	<td colspan="2" align="center" >
                      <input type="button" onclick="location.href='home.php?acceso=102'" value="volver"/>
