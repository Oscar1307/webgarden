	...
	<table width="700" border="0">
        ...
        <tr>
        	<td align="left">Placa del veh&iacute;culo </td> 
        	 <td> <input type="text" placeholder="Placa del veh&iacute;culo" name="placa" size="20" maxlength="15" required="required"  pattern="[A-Z]{3}[0-9]{3}" title="El formato debe coincidir con 3 letras may&uacute;sculas y 3 n&uacute;meros sin espacios." /></td>
    	...
    	<tr>
           ...
           <td> <input type="number" placeholder="N&uacute;mero de puestos" name="npuesto" size="20" maxlength="11" required="required" min="3" max="50" /></td>
        </tr>
        <tr>
       ...
       <tr>
        	<td align="left">Modelo  del veh&iacute;culo </td> 
        	 <td> <input type="number" placeholder="modelo" name="modelo" size="20" maxlength="11" required="required" min="1950" /></td>
	  ...
	  ?>
        <tr>
           ...
           <td class="style2" align="left"> <?php  echo $datos[$i]['marca'] ?></td>
            ...
            <td align="center"><a href="home.php?pr=<?php  echo $datos[$i]['idruta'] ?>&acceso=102&up=34"><img border=0 src="image/editar.png" width="25" height="25" /></a></td>
