<?php
include ("controlador/clistaalumnoacu.php");
?>
<center>
       ...
       <tbody>
            ...
            for ($i = 0; $i < count($datos); $i++) {
                ...
                <tr>
                    ...
                    <td align="center"><a href="home.php?pr=<?php echo $datos[$i]['identificacion'] ?>&acceso=117"><img border=0 src="image/novedad.png" width="35" height="35" /></a></td>
