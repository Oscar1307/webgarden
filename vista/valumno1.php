    ...
    <form name="form1" action="home.php?acceso=109" method="post"  onSubmit="return confirm('Por  favor primero  verifique  los datos ingresados  antes de hacer clic en  !aceptar!')" enctype="multipart/form-data" >
        ...
        <table width="700"  border="0" cellpadding="6">
            ...
            <tr>  
                ...
                <td colspan="1" align="left">Direcci&oacute;n<br><input type="text"  name="direc" size="35" maxlength="15" required="required" value="<?php echo $datosalumno[0]['direccion'] ?>" /></td>

                <td colspan="1" align="left">Fecha de nacimiento <br> <input type="date"  name="fechanaci" size="35" maxlength="20" required="required" value="<?php echo $datosalumno[0]['fecha_naci'] ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="0" align="left" > Descripci&oacute;n Enfermedades<br>
                    <textarea name="descripcion" maxlength="1000" required="required" rows="4" cols="51"><?php echo $datosalumno[0]['desenf']?></textarea></td>
                <td colspan="0" align="left" >Restricciones<br>
                    <textarea name="restri" maxlength="1000" required="required" rows="4" cols="51"><?php echo $datosalumno[0]['retri']?></textarea></td>
...
//echo $sql;
            ...
            <tr>
                <td colspan="2"align="center">
                    ...
                    <input  type="submit" value="Editar" onclick="comprobacion(this.form, this.form.files.value)"/>
