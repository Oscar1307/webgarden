       ...
       <tbody>
            ...
            for ($i = 0; $i < count($listacurso); $i++) {
                ...
                <tr>
                    ...
                    <td align="center" width="150"><?php echo $listacurso[$i]['curso'];?></td>
                    <td align="center"> <?php echo $listacurso[$i]['nivel']?></td>
                    <td align="center" width="150"><a href="home.php?acceso=151&idcurso=<?php echo $listacurso[$i]['idcurso']; ?>"><img src="image/lupa.png" width="25" height="25"></a> </td>
